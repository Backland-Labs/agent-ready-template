...
A single prompt, `REPO_CREATION.md`, that walks a coding agent through setting up a TypeScript web app repository from scratch: Bun, Vite + React, strict TypeScript, Biome for linting and formatting, Vitest, Husky pre-commit hooks, and GitHub Actions CI.
